    ...
    init:function() {
        ...
        app.socket.onmessage = function(event) {
            ...
            if(data.chat_id == currentChatId) {
                ...
                messageFragment.querySelector('.chat-message__body').style.padding='1.4em';
                messageFragment.classList.add (data.author_id == document.querySelector('#userId').value ? 'isAuthor' : 'isNotAuthor');
